...
GPIO.setup(16, GPIO.OUT)  # direction control top 1
GPIO.setup(18, GPIO.OUT)  # direction control top 2
GPIO.setup(29, GPIO.OUT)  # direction control bottom 1
GPIO.setup(31, GPIO.OUT)  # direction control bottom 2
